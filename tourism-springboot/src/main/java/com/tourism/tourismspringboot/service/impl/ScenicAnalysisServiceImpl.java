...
public class ScenicAnalysisServiceImpl implements IScenicAnalysisService {
    ...
    public Map<String, Object> getScenicListWithPage(Integer page, Integer pageSize) {
        ...
        try {
            String countSql = "SELECT COUNT(DISTINCT scenic_spot) as total FROM fuzhou_reviews WHERE scenic_spot IS NOT NULL";
            ...
            List<ScenicVO> list = hiveJdbcTemplate.query(sql, (rs, rowNum) -> {
                ...
                vo.setTotalReviews(rs.getLong("total_reviews"));
                vo.setAvgRating(rs.getDouble("avg_rating"));
                vo.setTotalVisitors(rs.getLong("total_reviews"));
                return vo;
            });
    ...
    public Map<String, Object> getReviewKeywords(String spotId, Integer limit) {
        ...
        try {
            ...
            String sql = 
                "SELECT review_content FROM fuzhou_reviews WHERE scenic_spot = ? LIMIT 100";
    ...
    public List<Map<String, Object>> getScenicRanking(String rankType, Integer limit) {
        ...
        try {
            return hiveJdbcTemplate.query(sql, new Object[]{limit}, (rs, rowNum) -> {
                ...
                map.put("spotName", rs.getString("scenic_spot"));
                if ("visitor".equals(rankType)) {
                    map.put("visitorCount", rs.getLong("visitor_count"));
                } else {
        ...
        try {
            ...
            result.put("topProvinces", topProvinces.stream()
                .map(m -> {
                    ...
                    province.put("province", m.get("city"));
    ...
    public Map<String, Object> getRecommendVisitTime(String spotId) {
        ...
        try {
            // 查询景区基本信息
            String infoSql = 
                "SELECT scenic_spot FROM fuzhou_reviews WHERE scenic_spot = ? LIMIT 1";
